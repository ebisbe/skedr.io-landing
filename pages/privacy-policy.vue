        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <p>
                Skedr.io ("us", "we", or "our") operates the https://skedr.io website and the Skedr.io mobile
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <p>
                If you are located outside Spain and choose to provide information to us, please note that we transfer
                the data, including Personal Data, to Spain and process it there.
              </p>
              <p>
              ...
              <p>
                Skedr.io will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <p>Skedr.io may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Skedr.io</li>
